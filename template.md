# Intentional License 1.0 - Template
...
This license, the Intentional License 1.0, is designed to address these concerns by establishing clear boundaries for commercial use, particularly concerning competitive offerings, while maintaining the core tenets of open-source freedom for non-competing applications. Uniquely, the license itself is governed by smart contracts on the [BLOCKCHAIN_NETWORK] blockchain, making it the first truly decentralized software license where amendments, exceptions, and interpretations are decided through transparent on-chain voting.
...
**[BLOCKCHAIN_NETWORK] DAO ID**: [DAO_CONTRACT_ADDRESS]

All licensing amendments, new package proposals, contributor compensation decisions, and changes to governance rules are made on-chain through proposals and weighted contributor votes, as defined in the DAO contract. The DAO's smart contract source is licensed under this same Intentional License 1.0 and managed via [DAO_GOVERNANCE_HANDLE] on-chain.

### Voting Power Structure

| Contributor Level | Badge | Requirements | Voting Power |
|-------------------|-------|--------------|--------------|
| **Founders** | - | Founding members | [FOUNDER_VOTING_POWER] |
| **Core Maintainers** | 🌟 | Core team members | [CORE_VOTING_POWER] |
| **Diamond Contributors** | 💎 | [DIAMOND_REQUIREMENT]+ accepted PRs | [DIAMOND_VOTING_POWER] |
| **Gold Contributors** | 🥇 | [GOLD_REQUIREMENT]+ accepted PRs | [GOLD_VOTING_POWER] |
| **Silver Contributors** | 🥈 | [SILVER_REQUIREMENT]+ accepted PRs | [SILVER_VOTING_POWER] |
| **Bronze Contributors** | 🥉 | [BRONZE_REQUIREMENT]+ accepted PRs | [BRONZE_VOTING_POWER] |
...
5. **Set Revenue Thresholds** - Adjust the $[REVENUE_THRESHOLD] enterprise licensing threshold annually
...
12. **Set Attribution Rules** - Modify "Powered by [PROJECT_NAME]" display requirements
...
- **Standard Proposals**: [STANDARD_VOTING_POWER] total voting power to submit, [STANDARD_VOTING_PERIOD]-day voting period
- **Emergency Proposals**: [EMERGENCY_VOTING_POWER] total voting power to submit, [EMERGENCY_VOTING_PERIOD]-hour voting period
- **License Modifications**: [LICENSE_VOTING_POWER] total voting power to submit, [LICENSE_VOTING_PERIOD]-day voting period
- **Quorum**: [QUORUM_PERCENTAGE]% of active voting power must participate for valid results
